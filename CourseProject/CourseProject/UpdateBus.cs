...
namespace CourseProject
{
    ...
    public partial class UpdateBus : Form
    {
        ...
        {
            if (newDepTimeTExt.Text.Length == 6 && numCheck())
            {
                string number = numberText.Text;
                string newDepTime = newDepTimeTExt.Text;
                string sqlExpression = $"UPDATE user_info SET dep_time='{newDepTime}' WHERE number='{number}'";
        ...
        {
            if (newNumberText.Text.Length > 4 && numCheck())
            {
                string number = numberText.Text;
        ...
        {
            if (newTypeBox.Text.Length != 0 && numCheck())
            {
                string number = numberText.Text;
        ...
        {
            if (newDestBox.Text.Length != 0 && numCheck())
            {
                string number = numberText.Text;
        ...
        {
            if (newDepDateText.Text.Length == 8 && numCheck())
            {
                string number = numberText.Text;
        ...
        {
            if (newArrTimeText.Text.Length == 5 && numCheck())
            {
                string number = numberText.Text;
        ...
        {
            if (newCostText.Text.Length != 0 && numCheck())
            {
                string number = numberText.Text;
                double newCost = Convert.ToDouble(newCostText.Text);
                MessageBox.Show(Convert.ToString(newCost));
        ...
        {
            if (newNumLeftUpDown.Value > 0 && numCheck())
            {
                string number = numberText.Text;
